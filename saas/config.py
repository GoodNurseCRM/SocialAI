...
PLATFORMS: dict[str, PlatformDef] = {
    "facebook": PlatformDef(
        ...
        color="#1877F2",
        auth_type="oauth2",
        oauth_scope="public_profile,pages_show_list,pages_read_engagement,pages_manage_posts,pages_manage_metadata,instagram_basic,instagram_content_publish,instagram_manage_insights",
