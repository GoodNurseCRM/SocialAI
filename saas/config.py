...
PLATFORMS: dict[str, PlatformDef] = {
    "facebook": PlatformDef(
        ...
        color="#1877F2",
        auth_type="oauth2",
        oauth_scope="pages_show_list,pages_read_engagement,pages_manage_posts,pages_manage_engagement,publish_to_groups",
    ...
    "instagram": PlatformDef(
        ...
        color="#E1306C",
        auth_type="oauth2",
        oauth_scope="instagram_basic,instagram_content_publish,instagram_manage_insights,pages_show_list",
